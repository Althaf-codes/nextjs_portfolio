...
const LatestBlogSection = () => {
  ...
  <div className="container px-5 pb-16 mx-auto">
    <div className="flex flex-col">
      <div className="h-1 bg-gray-200 rounded overflow-hidden flex flex-row">
        <div className="w-1/3 h-full bg-gray-200"></div>
        <div className="w-1/3 h-full bg-green-500"></div>
        <div className="w-1/3 h-full bg-gray-200"></div>
      </div>
      <div className="flex flex-col text-center w-full my-16">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Latest Blogs</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac humblebrag.</p>
    </div>
    </div>

  <div className="container px-10 pt-10 pb-10 mx-auto">
        ...
        <div className="h-full border-2 border-gray-800 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center flex-wrap ">
              <a className="text-green-400 inline-flex items-center md:mb-2 lg:mb-0">Read More
  ...
  <div className="pt-5 w-full">
        <Link href={'/blog'}>
          <button className="flex mx-auto text-white bg-green-600 border-0 py-2 px-8 focus:outline-none hover:bg-green-700 rounded text-lg">View All</button>
        </Link>
   </div>

    {/* <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-10">
