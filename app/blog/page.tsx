        ...
        {blogs.map((blog:BlogModel,index:number)=>(
                                ...
                                <div
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            <h2 className="text-xl font-semibold mb-2 text-gray-200">{blog.title}</h2>
                                            <p className="text-gray-400 mb-4">{blog.description}</p>

                                            <Link
                                                className={`${buttonVariants({ variant: "default" })} text-green bg-gray-500 hover:bg-green-800 hover:text-white transition duration-200`}
...
export const metadata: Metadata = {
    title:"Latest Blogs on Web Development, Programming Tutorials, and Tech Insights",
    description: "Explore our blog page for the latest articles on web development, JavaScript tutorials, programming best practices, and tech insights. Stay updated with expert content to advance your coding skills"
  }
